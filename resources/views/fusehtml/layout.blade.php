...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="{{secure_asset('storage/'.setting('site.favicon'))}}" />
...
<body class="layout layout-vertical layout-left-navigation layout-below-toolbar bg-fuse-dark text-auto">
    <main>
        <?php
